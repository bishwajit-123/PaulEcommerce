...
function SingleProducts({AddToCart}) {
  ...
  return (
    <div>
                ...
                <img alt="ecommerce" className="lg:w-[500px] w-full lg:h-auto h-64 object-cover object-center rounded-lg border-2 shadow-xl" src={singleproduct.thumbnail} />
                <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 border-2 rounded-lg shadow-xl ">
                    ...
                    <button className="text-white border rounded-lg bg-blue-500 p-2 text-sm md:text-lg cursor" onClick={() => handleAddToCart(singleproduct)}>Add to cart</button>
                  )}
                ...
                <Link to = "/allproduct" >
                < div className="flex font-semibold text-indigo-600 text-sm py-5 justify-center">
